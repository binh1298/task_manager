                ...
                child: ListView(
                  children: <Widget>[
                    ...
                    RaisedButton(
                      ...
                      onPressed: () async {
                        final result = await Navigator.pushNamed(context, '/updateConfirmationImg');
                        if(result) {
                          setState(() {
                            _taskUpdateDetails.confirmationImg = result;
                          });
                        };
                      },
                    ...
                    TextFormFieldComponent(
                      ...
                      onSaved: (value) {
                        setState(() {
                          _taskUpdateDetails.submitDescription = value;
                        });
                      },
                    ),
                    SizedBox(
