...
class CardGroupDetails extends StatelessWidget {
  final String avatar, groupName, fullname, roleName, email, phoneNumber, managerId;
  CardGroupDetails({this.managerId, this.avatar, this.email, this.fullname, this.roleName, this.groupName, this.phoneNumber});
